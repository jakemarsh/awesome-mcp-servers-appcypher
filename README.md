...
- <img src="https://bankbridge.money/favicon.ico" height="14"/> [bankbridge-skills](https://github.com/bankbridge-money/bankbridge-skills) - Read-only bank data for AI agents: accounts, transactions, recurring charges, cashflow, and investment holdings via a remote MCP server at bankbridge.money.
