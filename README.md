...
- <img src="https://bankbridge.money/favicon.ico" height="14"/> [BankBridge](https://github.com/bankbridge-money/bankbridge-plugin) - Read-only bank access for your AI agent. Hosted MCP server (streamable HTTP) that connects Claude, ChatGPT, Cursor, Gemini, and Codex to real bank accounts, transactions, and investment holdings via Plaid. 12 tools — balances, spending, cashflow, recurring charges, holdings, investment transactions. Live-fetch, nothing cached.
